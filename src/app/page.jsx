...
function dflt(){return{zona:"Todas",tipo:"Todos",localidad:"Todas",barrio:"Todos",conjunto:"Todos",precioTag:"",precioMin:"",precioMax:"",habitaciones:"Todas","baños":"Todos",pisoMax:"",garaje:false,ascensor:false,bonoHabi:false,duplex:false,deposito:false}}
...
export default function App(){
  ...
  const applyF=()=>{
    ...
    let c=0;if(na.zona&&na.zona!=="Todas")c++;if(na.tipo!=="Todos")c++;if(na.localidad!=="Todas")c++;if(na.barrio!=="Todos")c++;if(na.conjunto!=="Todos")c++;if(na.precioTag&&na.precioTag!=="Todos")c++;if(na.habitaciones!=="Todas")c++;if(na["baños"]!=="Todos")c++;if(na.pisoMax)c++;if(na.garaje)c++;if(na.ascensor)c++;if(na.bonoHabi)c++;if(na.deposito)c++;
