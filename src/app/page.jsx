...
function handleScheduleClick(p){trackSchedule(p);const url=typeof window!=="undefined"?window.location.href:"";const msg=`Hola, quiero agendar una visita para el apto ${url}`;const waUrl="https://wa.me/"+WA+"?text="+encodeURIComponent(msg);notifyAndWhatsApp(p,waUrl)}
