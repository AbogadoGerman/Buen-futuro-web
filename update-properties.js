...
const CONFIG = {
  ...
  placeholderImage: "/window.svg", // Usamos el SVG que ya existe
...
async function main() {
  try {
    ...
    // Guardamos el JSON de forma segura para que la web lo pueda leer
    fs.writeFileSync(CONFIG.outputPath, JSON.stringify(enriched, null, 2));
